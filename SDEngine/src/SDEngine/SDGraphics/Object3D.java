 ...
 * 
 *         Use these lines if reading from a file FileReader fr = new
 *         FileReader(ref); BufferedReader br = new BufferedReader(fr);
 * 
 *         Use these lines if reading from within a jar InputStreamReader fr =
 *         new InputStreamReader(new
 *         BufferedInputStream(getClass().getClassLoader
 *         ().getResourceAsStream(ref))); BufferedReader br = new
 *         BufferedReader(fr);
 */

public class Object3D extends SDGraphicsObject {

  private ArrayList vertexsets = new ArrayList(); // Vertex Coordinates
  private ArrayList vertexsetsnorms = new ArrayList(); // Vertex Coordinates
                                                       // Normals
